    ...
    if (error) {
      ...
      setMessage(
        <div>
          ...
          <p>Your pseudo is already taken.</p>
        </div>
      );
                ...
                <div className="dark:bg-slate-800 bg-slate-300 space-y-6 px-4 py-5 sm:p-6">
                  <div className="grid grid-cols-6 gap-6">
                    <div className="col-span-6 text-center">
                      ...
                      <label className="block text-sm font-medium text-gray-500 pt-1">
                        Avatar
                      </label>
                    </div>
                    ...
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <input
                        ...
                        id="email"
                        autoComplete="family-name"
                        className="mt-1 block w-full rounded-md border-gray-500 text-gray-500 dark:bg-slate-800 bg-slate-300 shadow-sm focus:border-rose-500 focus:ring-rose-500 sm:text-sm"
                        readOnly={true}
                        required
                      />
                    </div>
